...
This repository is a [Bomly](https://bomly.dev) example project for **Python** with **Poetry**.
...
| `poetry.lock` | Dependency manifest |
...
```bash
bomly scan --url https://github.com/bomly-dev/example-python-poetry
```
...
```bash
bomly scan --url https://github.com/bomly-dev/example-python-poetry --enrich --audit
```
...
```bash
bomly scan --url https://github.com/bomly-dev/example-python-poetry --enrich --reachability
```
...
```bash
bomly explain django --url https://github.com/bomly-dev/example-python-poetry
```
